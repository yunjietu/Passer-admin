...
![Passer-admin](https://i.daka1.com/logo.svg)
...
**一个基于Spring Boot 3 + Vue 3的综合实习打卡管理系统，支持多平台自动实习打卡和报告提交功能**
...
Passer-admin 是一个功能强大的综合实习自动打卡管理系统，专为教育机构和企业设计，支持多个主流平台的实习自动打卡和报告提交功能。系统基于现代化的技术栈构建，提供稳定、高效、易用的打卡解决方案。

### 🎯 核心功能

- **多平台支持**: 工学云、学习通、职校家园、云上河开、哈科职院、i水院自动打卡
- **实习自动打卡**: 定时自动签到，支持多种打卡方式
